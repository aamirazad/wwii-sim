/** biome-ignore-all lint/performance/noImgElement: image is too expensive I don't care either */
import React, { useCallback, useEffect, useMemo, useRef } from "react";

const DEFAULT_INNER_GRADIENT = "none";

const TITLE_TO_AVATAR_MAP: Record<string, string> = {
	Commonwealth: "https://r2.aamirazad.com/uk-flag.webp",
	France: "https://r2.aamirazad.com/france-flag.webp",
	Germany: "https://r2.aamirazad.com/germany-flag.webp",
	Italy: "https://r2.aamirazad.com/italy-flag.webp",
	Japan: "https://r2.aamirazad.com/japan-flag.webp",
	Russia: "https://r2.aamirazad.com/russia-flag.webp",
	"United Kingdom": "https://r2.aamirazad.com/uk-flag.webp",
	"United States": "https://r2.aamirazad.com/us-flag.webp",
	Mods: "https://r2.aamirazad.com/un-flag.webp",
};
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
	...
	const getOffsets = useCallback(
		(evt: PointerEvent, el: HTMLElement): { x: number; y: number } => {
	...
	// Compute avatar URL from title if not explicitly provided
	const resolvedAvatarUrl = useMemo(
		() =>
			avatarUrl && avatarUrl !== "<Placeholder for avatar URL>"
				? avatarUrl
				: (TITLE_TO_AVATAR_MAP[title] ?? avatarUrl),
		[avatarUrl, title],
	);
	...
	return (
		...
		>
			...
			<div ref={shellRef} className="relative z-1 group">
				{/** biome-ignore lint/a11y/noStaticElementInteractions: sorry, I didn't make the code */}
				<section
				...
				>
					...
					>
						...
						>
							<img
								className="w-full h-full absolute left-1/2 top-0 will-change-transform transition-transform duration-120 ease-out"
								...
								style={{
									...
									transform:
										"translateX(calc(-50% + (var(--pointer-from-left) - 0.5) * 6px)) translateZ(0) scale(1.03)",
									borderRadius: cardRadius,
									backfaceVisibility: "hidden",
									objectFit: imageFit,
									...
									<div className="flex items-center gap-3">
										...
										>
											<img
												...
												src={miniAvatarUrl || resolvedAvatarUrl}
