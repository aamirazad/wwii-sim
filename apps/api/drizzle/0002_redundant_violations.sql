CREATE TABLE `year_schedules` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`game_id` integer NOT NULL,
	`scheduled_year` integer NOT NULL,
	`scheduled_time` integer NOT NULL,
	`created_by` text NOT NULL,
	`created_at` integer DEFAULT '"2026-01-30T01:52:33.855Z"' NOT NULL,
...
CREATE TABLE `__new_country_state` (
	...
	`created_at` integer DEFAULT '"2026-01-30T01:52:33.855Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-01-30T01:52:33.855Z"' NOT NULL,
	FOREIGN KEY (`game_id`) REFERENCES `games`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `__new_games` (
	...
	`year_durations` text,
	`created_at` integer DEFAULT '"2026-01-30T01:52:33.854Z"' NOT NULL
);
--> statement-breakpoint
