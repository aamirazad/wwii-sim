...
CREATE TABLE `troop_location` (
	...
	`submarines` integer DEFAULT 0 NOT NULL,
	`created_at` integer DEFAULT '"2026-02-07T20:21:53.935Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-02-07T20:21:53.935Z"' NOT NULL,
	FOREIGN KEY (`country_state_id`) REFERENCES `country_state`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`game_id`) REFERENCES `games`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `__new_game_state` (
	...
	`data` text,
	`updated_at` integer DEFAULT '"2026-02-07T20:21:53.934Z"' NOT NULL,
	FOREIGN KEY (`game_id`) REFERENCES `games`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `__new_games` (
	...
	`year_durations` text,
	`created_at` integer DEFAULT '"2026-02-07T20:21:53.934Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`role` text NOT NULL,
	`country` text,
	`created_at` integer DEFAULT '"2026-02-07T20:21:53.933Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_year_schedules` (
	...
	`created_by` text NOT NULL,
	`created_at` integer DEFAULT '"2026-02-07T20:21:53.936Z"' NOT NULL,
	FOREIGN KEY (`game_id`) REFERENCES `games`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`created_by`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
