...
CREATE TABLE `__new_announcements` (
	...
	`created_at` integer DEFAULT '"2026-02-07T22:51:37.985Z"' NOT NULL,
...
CREATE TABLE `__new_country_state` (
	...
	`created_at` integer DEFAULT '"2026-02-07T22:51:37.985Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-02-07T22:51:37.985Z"' NOT NULL,
	FOREIGN KEY (`game_id`) REFERENCES `games`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `__new_game_state` (
	...
	`data` text,
	`updated_at` integer DEFAULT '"2026-02-07T22:51:37.984Z"' NOT NULL,
	FOREIGN KEY (`game_id`) REFERENCES `games`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `__new_games` (
	...
	`year_durations` text,
	`created_at` integer DEFAULT '"2026-02-07T22:51:37.984Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`role` text NOT NULL,
	`country` text,
	`created_at` integer DEFAULT '"2026-02-07T22:51:37.983Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_year_schedules` (
	...
	`created_by` text NOT NULL,
	`created_at` integer DEFAULT '"2026-02-07T22:51:37.986Z"' NOT NULL,
	FOREIGN KEY (`game_id`) REFERENCES `games`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`created_by`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
